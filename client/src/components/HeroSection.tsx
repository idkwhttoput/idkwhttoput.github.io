        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button 
                asChild
                variant="outline"
                className="bg-white hover:bg-gray-100 text-primary border border-primary font-medium py-3 px-6 rounded-lg transition-colors"
              >
          ...
          <div className="w-full md:w-2/5">
            <img 
              ...
              className="rounded-full w-64 h-64 md:w-80 md:h-80 object-cover mx-auto shadow-lg border-4 border-white" 
            />
          </div>
        </div>
      </div>
